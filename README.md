...
| 合購 | `134ac93c-ea95-4e68-a533-d0ac2813fddf` AI 軍火庫（課程＋24 大模組）62,000 |
...
合購按鈕寫入的是 **Kolable 上獨立的合購方案**「AI 軍火庫」（`bundle.kolablePlanId`），
不是把兩個單品各丟一筆 —— 那樣會結成 80,000 而不是 62,000。
**寫入是取代，不是追加** —— 按哪個方案就結哪個方案。
